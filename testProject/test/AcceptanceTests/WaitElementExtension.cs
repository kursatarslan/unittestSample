...
namespace AcceptanceTests
{
    public static class WaitElementExtension
    {
        ...
        {
            return new WebDriverWait(driver, GetTimeout(waitInSeconds)).Until(x =>
            {
                try
                {
        ...
        {
            return seconds != null ? TimeSpan.FromSeconds(seconds.Value) : DefaultTimeout;
        }
    }
}